# Generated by Django 4.2.2 on 2023-07-21 18:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_inicio', models.DateField(blank=True, null=True, verbose_name='Desde')),
                ('fecha_fin', models.DateField(blank=True, null=True, verbose_name='Hasta')),
                ('min_acumulados', models.IntegerField(blank=True, null=True)),
                ('explicacion', models.CharField(blank=True, max_length=600, null=True, verbose_name='Explicacion')),
                ('estado_accion', models.BooleanField(blank=True, default=False, null=True, verbose_name='Estado accion')),
            ...
            options={
                'verbose_name': 'historical cronograma_vacaciones',
                'verbose_name_plural': 'historical cronogramas_vacaciones',
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'cronograma_vacaciones',
                'verbose_name_plural': 'cronogramas_vacaciones',
