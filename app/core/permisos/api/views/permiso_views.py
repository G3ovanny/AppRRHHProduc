        ...
        if permiso:
            ...
            if permiso_serializer.is_valid():
                ...
                if motivo == id_motivo:
                    ...
                    dia_vacaciones = ((dias_vacaciones[0]) * 8) *60
                    #resta = dia - suma1
                        #Trabajador.objects.filter(numero_identificacion=id_trabajador).update(dias_vacaciones=resta)
                    
                    suma_min = min_acumulados + dia_vacaciones # sumo los minutos que se quita al crear
                    print('sumos los min restados', suma_min)
                    mi_acum = suma_min - suma
                    print('sumo los min nuevos a vacaciones', mi_acum)
                        #resta = min_acumulados - suma
                        #minutos = (dia_vacaciones + resta)-min_acumulados
